function [] = plot_simulations(xYaw, yYaw, xPitch, yPitch, xRoll, yRoll, voltF, voltB, voltR, voltL, lStart, initials, tStart, tTime, fontsize, savePlot, plotName, simuName)
    close all
    vLength = length(xYaw);
